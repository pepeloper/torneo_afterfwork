    ...
    <>
      ...
      <main className="max-w-2xl mx-auto">
        ...
        <section className="px-4 mt-5">
          <button onClick={() => setRegisterModal(true)} className="w-full flex items-center space-x-3 px-4 py-3 border border-deep-orange-600 rounded-lg bg-deep-orange-50 text-gray-800">
