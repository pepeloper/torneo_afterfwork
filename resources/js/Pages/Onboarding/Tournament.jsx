...
import { Button, ButtonGroup, Tab, TabPanel, Tabs, TabsBody, TabsHeader, Typography } from "@material-tailwind/react";
...
export default function Welcome({ players, courts }) {
  ...
  const handleSubmit = (event) => {
    ...
    get(route('onboarding.tournament', { players: data.number_of_players, courts: data.courts }));
  }
    ...
    <>
      ...
      <main className="">
        ...
        <section className="px-4 mt-5">
          <div className="flex items-center space-x-3 px-4 py-3 border border-deep-orange-600 rounded-lg bg-deep-orange-50 text-gray-800">
