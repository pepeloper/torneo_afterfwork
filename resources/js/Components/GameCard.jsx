    ...
    <>
      <div className="border border-gray-700/30 bg-gray-700/10 rounded-md">
        ...
        <div className="text-base">
          <div className="grid grid-cols-3 grid-rows-1 items-center px-4 pb-2">
          ...
          </div>
          {
            auth.user && <div className="w-full">
              {editMode ?
                <button type="button" className="bg-light-green-500/10 w-full py-2 rounded-b-md" onClick={handleEditGame}>Guardar puntuación</button> :
                <button type="button" className="bg-gray-950/50 w-full py-2 rounded-b-md" onClick={() => setEditMode(!editMode)}>Añadir puntuación</button>
              }
            </div>
          }
        </div>
