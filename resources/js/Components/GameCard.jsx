        ...
        <div className="text-base">
          <div className="grid grid-cols-3 grid-rows-1 items-center px-4">
            ...
            <div className="flex items-center justify-center space-x-4 text-xl">
              {editMode ?
                <input className="w-6 h-10 p-0 text-gray-900 text-center" autoFocus type="text" value={data.first_team_points} onChange={e => setData('first_team_points', e.target.value)} /> :
                <p>{data.first_team_points}</p>
              }
              <p className="text-center">vs</p>
              {editMode ?
                <input className="w-6 h-10 p-0 text-gray-900 text-center" type="text" value={data.second_team_points} onChange={e => setData('second_team_points', e.target.value)} /> :
